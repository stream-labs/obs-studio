...
static bool ffmpeg_encoded_output_is_ready_for_settings_update(void *data)
{
	struct ffmpeg_encoded_output *stream = data;
...
struct obs_output_info ffmpeg_encoded_output_info = {
	...
	.is_ready_for_settings_update = ffmpeg_encoded_output_is_ready_for_settings_update,
};
