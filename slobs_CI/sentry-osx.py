...
# process_sentry(os.path.join(os.environ['PWD'], os.environ['SLBUILDDIRECTORY'], 'libobs-src', 'bin'))
# # Upload obs-plugins debug files
# process_sentry(os.path.join(os.environ['PWD'], os.environ['SLBUILDDIRECTORY'], 'libobs-src', 'obs-plugins'))
