...
-DWEBRTC_LIB_PATH=$DEPS_DIR/webrtc_dist/webrtc.a \
-DMEDIASOUP_INCLUDE_PATH=$DEPS_DIR/libmediasoupclient_dist/include/mediasoupclient/ \
-DMEDIASOUP_LIB_PATH=$DEPS_DIR/libmediasoupclient_dist/lib/mediasoupclient.a \
-DMEDIASOUP_SDP_LIB_PATH=$DEPS_DIR/libmediasoupclient_dist/lib/sdptransform.a \
