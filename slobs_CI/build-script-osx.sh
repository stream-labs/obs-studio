...
-DWEBRTC_INCLUDE_PATH=deps/webrtc_dist \
-DWEBRTC_LIB_PATH=deps/webrtc_dist/webrtc.a \
-DMEDIASOUP_INCLUDE_PATH=deps/libmediasoupclient_dist/include/mediasoupclient/ \
-DMEDIASOUP_LIB_PATH=deps/libmediasoupclient_dist/lib/mediasoupclient.a \
-DMEDIASOUP_SDP_LIB_PATH=deps/libmediasoupclient_dist/lib/sdptransform.a \
-DMEDIASOUP_SDP_INCLUDE_PATH=deps/libmediasoupclient_dist/include/sdptransform \
